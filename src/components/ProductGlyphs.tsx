...
const GLASS = "rgba(20,18,14,0.68)";
const DARK = "#efeae0";
const GOLD = "#8a6215";
const WOOD = "#d7c3ad";
...
export function DiffuserGlyph({ liquid, height = 88 }: { liquid: string; height?: number }) {
  return (
    <svg width={height * 0.5} height={height} viewBox="0 0 44 88" fill="none" aria-hidden>
      ...
      <path d="M12 22h20l-2 12H14z" fill={WOOD} stroke="#7c5630" strokeWidth="0.8" />
...
export function SetGlyph({ liquid, height = 88 }: { liquid: string; height?: number }) {
  return (
    <svg width={height * 1.9} height={height} viewBox="0 0 168 88" fill="none" aria-hidden>
      <rect x="2" y="12" width="164" height="72" rx="2" fill="#14120e" stroke={GLASS} strokeWidth="1" />
      <rect x="6" y="16" width="156" height="64" fill="#14120e" stroke="rgba(138,98,21,1)" strokeWidth="0.8" />
      ...
      <text x="84" y="78" textAnchor="middle" fontFamily="'Cormorant Garamond',serif" fontSize="7" letterSpacing="1.5" fill={GOLD}>KILAU BALI</text>
    </svg>
  );
}
