          ...
          <svg viewBox={`0 0 ${VIEW} ${VIEW}`} style={{ display: "block", width: "100%", height: "auto" }} role="presentation">
            <defs>
              <radialGradient id="sdCore" cx="50%" cy="50%" r="50%">
                <stop offset="0%" stopColor="rgba(122,90,18,0.95)" />
                <stop offset="55%" stopColor="rgba(138,98,21,1)" />
                <stop offset="100%" stopColor="rgba(138,98,21,1)" />
              </radialGradient>
              <radialGradient id="sdField" cx="50%" cy="50%" r="50%">
                <stop offset="0%" stopColor="rgba(31,111,139,0.12)" />
                <stop offset="70%" stopColor="rgba(31,111,139,0.03)" />
                <stop offset="100%" stopColor="rgba(31,111,139,0)" />
              </radialGradient>
            </defs>
            ...
            <g>
              ...
              <circle cx={CENTRE} cy={CENTRE} r={46} fill="rgba(20,18,14,0.9)" stroke={goldA(0.75)} strokeWidth="1.4" />
