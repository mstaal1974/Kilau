            ...
            return (
              ...
              >
                <div style={{ position: "relative" }}>
                  ...
                  <div style={{ position: "absolute", top: 14, left: 14, background: "rgba(255,255,255,0.82)", border: `1px solid ${goldA(0.5)}`, padding: "6px 10px", fontFamily: MONO, fontSize: 12, letterSpacing: "0.14em", color: SD.softGold }}>
                    {m.percent}%
                  </div>
                  {i === 0 && (
                    <div style={{ position: "absolute", top: 14, right: 14, background: goldA(0.9), padding: "6px 10px", fontFamily: MONO, fontSize: 8.5, letterSpacing: "0.22em", textTransform: "uppercase", color: SD.paper }}>
                      Closest
                    </div>
                  )}
                </div>
      ...
      <form onSubmit={submit} style={{ marginTop: 18 }}>
        ...
        <div style={{ display: "flex", gap: 10, marginTop: 10, flexWrap: "wrap" }}>
          <input
            ...
            style={{ flex: 1, minWidth: 200, background: "rgba(20,18,14,0.03)", border: "1px solid #8a8070", outline: "none", color: SD.text, fontSize: 13.5, padding: "12px 14px" }}
          />
...
function LeadForm({ print, onCode }: { print: Scentprint; onCode: (code: string) => void }) {
  ...
  return (
    <form onSubmit={submit} style={{ marginTop: 26, maxWidth: 560 }}>
      ...
      {state === "error" && <p style={{ ...micro, color: "#a8431b", marginTop: 12 }}>That email didn't look right — try again.</p>}
    </form>
  );
}
