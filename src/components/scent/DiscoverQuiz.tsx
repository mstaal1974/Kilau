  ...
  return (
    <button
      ...
      style={{
        ...
        boxShadow: active ? `0 24px 60px rgba(20,18,14,0.1), 0 0 0 1px ${goldA(0.4)}, 0 0 46px ${goldA(0.16)}` : glass.boxShadow,
        padding: 0,
        cursor: "pointer",
        textAlign: "left",
        overflow: "hidden",
    ...
    >
      <span
        ...
        style={{
          ...
          position: "relative",
          height: tall ? 220 : 152,
          background: `radial-gradient(120% 110% at 28% 0%, ${option.tone[1]}2E 0%, rgba(20,18,14,0) 62%), linear-gradient(165deg, ${option.tone[0]} 0%, ${SD.paper} 100%)`,
        }}
      >
              ...
              >
                {active && (
                  <svg width="9" height="9" viewBox="0 0 10 10" fill="none">
                    <path d="M1 5.4 3.8 8 9 2" stroke={SD.paper} strokeWidth="1.6" strokeLinecap="round" />
                  </svg>
                )}
              </span>
