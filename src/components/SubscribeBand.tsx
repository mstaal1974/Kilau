...
export default function SubscribeBand() {
  return (
    <section aria-label="The Monthly Pour" style={{ borderBottom: "1px solid #e4ddd0", background: "linear-gradient(135deg, rgba(200,160,99,0.08), transparent 55%)" }}>
      <Container style={{ padding: "36px 32px" }}>
        <div className="kb-band-grid" style={{ display: "grid", gridTemplateColumns: "1fr auto", gap: 32, alignItems: "center" }}>
          <div>
            ...
            <p style={{ margin: "12px 0 0", fontSize: 13.5, lineHeight: 1.65, color: "rgba(20,18,14,0.74)", maxWidth: 620 }}>
          ...
          <button className="kb-cta" style={btnGold} onClick={() => navigate(paths.subscribe())}>
