  ...
  return (
    ...
    >
      <div
        ...
        style={{ width: "100%", maxWidth: 420, background: "#ffffff", border: "1px solid #e4ddd0", padding: 28, animation: "moRise 0.3s ease" }}
      >
        <span style={{ fontFamily: "'Space Mono',monospace", fontSize: 10, letterSpacing: "0.24em", textTransform: "uppercase", color: "#8a6215" }}>
          Kilau Bali
        </span>
        <h2 style={{ margin: "14px 0 0", fontFamily: "'Cormorant Garamond',serif", fontWeight: 300, fontSize: 34, color: "#14120e" }}>
