...
export default function Thanks({ state, sessionId, signedIn, onJoin }: ThanksProps) {
  ...
  return (
    <main data-screen-label="Thank you" style={{ maxWidth: 720, margin: "0 auto", padding: "140px 32px 110px", textAlign: "center" }}>
      ...
      <p style={{ margin: "18px auto 0", maxWidth: 520, fontSize: 14, lineHeight: 1.75, color: "rgba(20,18,14,0.74)" }}>
      ...
      <div style={{ display: "flex", gap: 12, justifyContent: "center", flexWrap: "wrap", marginTop: 32 }}>
        {signedIn ? (
          <button className="kb-cta" style={btnGold} onClick={() => navigate(paths.account)}>
            My orders <Arrow />
          </button>
        ) : (
          <button className="kb-cta" style={btnGold} onClick={onJoin}>
      ...
      {!signedIn && (
        <p style={{ margin: "20px auto 0", maxWidth: 480, fontFamily: MONO, fontSize: 11, lineHeight: 1.7, color: "rgba(20,18,14,0.68)" }}>
