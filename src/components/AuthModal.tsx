...
export default function AuthModal({
  ...
  const tab = (active: boolean): CSSProperties => ({
    ...
    background: "none",
    border: 0,
    borderBottom: active ? "1px solid #c8a063" : "1px solid #e4ddd0",
    cursor: "pointer",
    padding: "0 0 12px",
    color: active ? "#8a6215" : "rgba(20,18,14,0.68)",
    fontSize: 11,
  ...
  return (
    ...
    >
      ...
      >
        ...
        <h2 className="kb-auth-title" style={{ margin: "14px 0 0", fontFamily: "'Cormorant Garamond',serif", fontWeight: 300, fontSize: 34, color: "#14120e" }}>
          {sent
            ? "Check your email."
            : forgot
            ? "Reset your password."
        ...
        {sent ? (
          ...
          <p style={{ margin: "10px 0 24px", fontSize: 12.5, lineHeight: 1.6, color: "rgba(20,18,14,0.68)" }}>
        ...
        {sent ? (
          <div>
            ...
            <p style={{ margin: "12px 0 0", fontSize: 12, lineHeight: 1.7, color: "rgba(138,98,21,1)" }}>
        ...
        {!forgot && !sent && mode === "signin" && (
          <button
            ...
            style={{ marginTop: 10, background: "none", border: 0, padding: 0, cursor: "pointer", color: "rgba(20,18,14,0.68)", fontFamily: "'Space Mono',monospace", fontSize: 10.5, letterSpacing: "0.1em", textDecoration: "underline" }}
          >
          ...
          <div style={{ marginTop: 16, display: "grid", gap: 10 }}>
            {(
              ...
              <label key={c.key} style={{ display: "grid", gridTemplateColumns: "18px 1fr", gap: 10, alignItems: "start", cursor: "pointer" }}>
                <input type="checkbox" checked={c.on} onChange={(e) => c.set(e.target.checked)} aria-label={c.label} style={{ marginTop: 2, accentColor: "#8a6215" }} />
                <span>
                  <span style={{ display: "block", fontSize: 12.5, color: "#14120e", lineHeight: 1.4 }}>{c.label}</span>
                  <span style={{ display: "block", fontSize: 11, color: "rgba(20,18,14,0.68)", lineHeight: 1.5 }}>{c.hint}</span>
                </span>
              </label>
            ))}
          </div>
        ...
        {error && <div style={{ marginTop: 12, fontSize: 11.5, lineHeight: 1.5, color: "#a8431b" }}>{error}</div>}
        ...
        {forgot && !sent && (
          <button
            onClick={leaveForgot}
            style={{ marginTop: 14, width: "100%", background: "none", border: 0, padding: 0, cursor: "pointer", color: "rgba(20,18,14,0.68)", fontFamily: "'Space Mono',monospace", fontSize: 10.5, letterSpacing: "0.1em" }}
          >
        ...
        {!forgot && !sent && (
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 14, margin: "22px 0" }}>
            <span style={{ flex: 1, height: 1, background: "#e4ddd0" }} />
            <span style={{ fontFamily: "'Space Mono',monospace", fontSize: 9, letterSpacing: "0.2em", textTransform: "uppercase", color: "rgba(20,18,14,0.68)" }}>
              or
            </span>
            <span style={{ flex: 1, height: 1, background: "#e4ddd0" }} />
          </div>
        ...
        {!configured && (
          <p style={{ margin: "18px 0 0", fontSize: 10.5, lineHeight: 1.6, color: "rgba(20,18,14,0.68)", textAlign: "center" }}>
