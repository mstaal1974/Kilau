...
export default function Footer() {
  ...
  return (
    <footer style={{ borderTop: "1px solid #e4ddd0", background: "#ffffff" }}>
      <div className="kb-footer-grid" style={{ maxWidth: 1400, margin: "0 auto", padding: "22px 32px", display: "flex", alignItems: "center", justifyContent: "space-between", gap: 28, flexWrap: "wrap" }}>
        <button onClick={() => navigate(paths.home)} style={{ display: "flex", alignItems: "center", gap: 11, background: "none", border: 0, cursor: "pointer", padding: 0 }}>
          ...
          <span style={{ textAlign: "left" }}>
            <span style={{ display: "block", fontFamily: SERIF, fontSize: 16, letterSpacing: "0.2em", fontWeight: 600, color: CREAM, lineHeight: 1 }}>
              KILAU <span style={{ color: GOLD, fontWeight: 500 }}>BALI</span>
            </span>
            <span style={{ display: "block", fontFamily: MONO, fontSize: 7.5, letterSpacing: "0.3em", color: "rgba(20,18,14,0.74)", marginTop: 4, textTransform: "uppercase" }}>Clothing &amp; Fragrance</span>
          </span>
        </button>
        <nav style={{ display: "flex", gap: 30, flexWrap: "wrap" }} aria-label="Footer">
          {LINKS.map((l) => (
            <button key={l.label} className="kb-navlink" onClick={() => navigate(l.to)} style={{ background: "none", border: 0, cursor: "pointer", color: "rgba(20,18,14,0.74)", fontFamily: MONO, fontSize: 14, letterSpacing: "0.22em", textTransform: "uppercase" }}>
              {l.label}
            </button>
          ))}
        </nav>
        ...
        >
          <span style={{ fontFamily: MONO, fontSize: 14, letterSpacing: "0.12em", color: "rgba(20,18,14,0.74)" }}>{joined ? "Welcome to the inner circle. Unsubscribe any time from your account." : "Join our inner circle"}</span>
          {!joined && (
            <label style={{ display: "flex", alignItems: "center", border: "1px solid #9c9078", height: 38, paddingLeft: 14 }}>
          ...
          <span style={{ display: "flex", gap: 14, marginLeft: 8, color: "rgba(20,18,14,0.74)" }} aria-label="Social">
      ...
      <div style={{ borderTop: "1px solid #efeae0" }}>
        <div style={{ maxWidth: 1400, margin: "0 auto", padding: "12px 32px", display: "flex", justifyContent: "space-between", fontFamily: MONO, fontSize: 8.5, letterSpacing: "0.22em", textTransform: "uppercase", color: "rgba(20,18,14,0.62)" }}>
          <span>© 2026 Kilau Bali</span>
