...
export default function ScentDna({ fragrances, userId, code: initialCode, onOpenProduct, onAddSample, onAddDiscoveryBox }: ScentDnaProps) {
  ...
  useEffect(() => {
    ...
    document.title = "Discover Your Scent DNA — Kilau Bali";
    const tags = [
      meta("name", "description", "A two-minute experience that maps your scent preferences and shows the Kilau Bali fragrances most likely to suit you."),
      meta("property", "og:title", "Discover Your Scent DNA — Kilau Bali"),
    ...
    <div style={{ position: "relative", minHeight: "100vh", color: SD.text, overflowX: "hidden" }}>
      ...
      >
        <div className="sd-pad" style={{ maxWidth: 1240, margin: "0 auto", padding: "0 32px", height: 68, display: "flex", alignItems: "center", justifyContent: "space-between", gap: 20 }}>
          <button onClick={() => navigate(paths.home)} style={{ display: "flex", alignItems: "center", gap: 11, background: "none", border: 0, cursor: "pointer", padding: 0 }} aria-label="Kilau Bali home">
            <Logo width={19} height={23} />
            <span style={{ textAlign: "left" }}>
              <span className="sd-wordmark" style={{ display: "block", fontFamily: SERIF, fontSize: 16, letterSpacing: "0.17em", fontWeight: 600, lineHeight: 1, color: SD.text, whiteSpace: "nowrap" }}>KILAU <span style={{ color: SD.gold, fontWeight: 500 }}>BALI</span></span>
      ...
      <footer style={{ position: "relative", zIndex: 1, borderTop: `1px solid ${ink(0.06)}` }}>
        <div className="sd-pad" style={{ maxWidth: 1240, margin: "0 auto", padding: "22px 32px", display: "flex", justifyContent: "space-between", gap: "10px 18px", flexWrap: "wrap" }}>
          <span style={{ ...micro, color: ink(0.3), lineHeight: 1.9 }}>© 2026 Kilau Bali · Scentprint™ · Scent Universe™</span>
          <span style={{ ...micro, color: ink(0.3), lineHeight: 1.9 }}>kilaubali.com/discover</span>
        </div>
      </footer>
    </div>
  );
    ...
    >
      <div style={{ maxWidth: 900 }}>
        ...
        <p className="sd-rise" style={{ margin: "14px auto 0", maxWidth: 620, fontSize: 14, lineHeight: 1.7, color: ink(0.42), animationDelay: "0.18s" }}>
          A two-minute experience that maps your scent preferences and shows the Kilau Bali fragrances most likely to suit you.
        </p>
    ...
    <div className="sd-pad" style={{ position: "relative", zIndex: 1, maxWidth: 1240, margin: "0 auto", padding: "26px 32px 0" }}>
      <div
        style={{
          ...
          background: "linear-gradient(100deg, rgba(200,160,99,0.12), rgba(127,208,240,0.05))",
          padding: "16px 20px",
        }}
      >
