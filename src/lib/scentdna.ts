...
/**
 * House colour for a family. Sixteen hues that have to stay apart from each
 * other and legible on paper: every one clears 3:1 against white, which is what
 * a graphical object needs when it is carrying meaning (the ring, the universe
 * chart, the share card key).
 */
