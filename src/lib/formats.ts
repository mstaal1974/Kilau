...
export interface Sku {
  key: FormatKey;
  def: FormatDef;
  code: string; // SMOKY-PAPER-PERF-50
  price: number; // cents
...
// The swatch is the only thing that tells these buttons apart at a glance, so
// each one clears 3:1 against paper and stays distinct from its neighbours.
export const MOODS: { id: Mood; hint: string; swatch: string }[] = [
  { id: "Woody", hint: "cedar, sandalwood, vetiver", swatch: "#6B4A2B" },
  { id: "Fresh", hint: "citrus, sea air, green", swatch: "#2E8B6F" },
  { id: "Spicy", hint: "pepper, cinnamon, saffron", swatch: "#B24A2A" },
  { id: "Dark", hint: "oud, smoke, resin", swatch: "#4A4450" },
  { id: "Clean", hint: "musk, cotton, aldehydes", swatch: "#5A7E96" },
  { id: "Floral", hint: "rose, jasmine, iris", swatch: "#B4557F" },
  { id: "Sweet", hint: "vanilla, tonka, amber", swatch: "#A6761B" },
  { id: "Gourmand", hint: "coffee, caramel, praline", swatch: "#8A5A2B" },
  { id: "Evening", hint: "intense, statement, night", swatch: "#5E5A63" },
  { id: "Summer", hint: "bright, airy, aquatic", swatch: "#1F6F8B" },
];
...
// ─── Find your Kilau: match a fragrance or brand the customer knows ───────
