...
export function localFallbackReply(text: string, frags: Fragrance[]): string {
  ...
  if (!t || has("hello", "hi ", "hey", "help")) {
    return "Welcome to Kilau Bali. I can recommend a scent by note or occasion, or walk you through sizes, engraving, the Monthly Pour, VIP, and shipping. What are you after?";
  }
